    ...
    <Row id="filter-issue-panel">
        ...
        <Row>
            ...
            <div className="btn-group" role="group">
                <Button id="calendar-view-select" className="btn btn-default">
                    <span className="glyphicon glyphicon-calendar" aria-hidden="true"></span>
                </Button>
            </div>
            <div className="btn-group" role="group">
                <Button id="schedule-view-select" className="btn btn-default">
                    <span className="glyphicon glyphicon-tasks" aria-hidden="true"></span>
                </Button>
            </div>
            <div className="btn-group" role="group">
                <Button id="list-view-select" className="btn btn-default">
    ...
    <Row id="create-issue-panel" hidden>
        ...
        <div className="panel-body">
            <form id="create-issue-form">
                ...
                <Col md={6}>
                <div className="form-group">
                    <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="name">Titel</label>
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="assignedid">Tilldelad</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="startdatestring">Startdatum</label>
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="enddatestring">Slutdatum</label>
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="issueclassid">Ärendeklass</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="prio">Prioritet</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="responsible">Utförare</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="description">Beskrivning</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
        ...
        <Col md={6}>
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="areatype">Utrymme</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
        ...
        <div className="form-group"><label className="control-label col-md-3" htmlFor="residentid" style="margin-left:-15px;margin-right:15px;">Boende</label>
            <Col md={9} className="input-group">
                <span className="input-group-addon">
                    <span className="glyphicon glyphicon-unchecked">
                    </span>
                </span>
                <select data-autoajax="true" data-width="100%" id="residentid" name="residentid">
                </select>
            </Col>
        </div>
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="firstname">Förnamn</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
                <span className="glyphicon glyphicon-user"></span>
            </span>
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="lastname">Efternamn</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
                <span className="glyphicon glyphicon-user"></span>
            </span>
        ...
        <div className="form-group"Col>
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="phone">Telefon</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="email">E-post</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="address">Adress</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
                <span className="glyphicon glyphicon-map-marker"></span>
            </span>
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="floor">Våningsplan</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
        ...
        <div className="form-group">
            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="apartment">Lägenhet</label>
            <Col md={9} className="input-group">
            <span className="input-group-addon">
        ...
        <table id="issuelist-table" className="table table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th>Prio</th>
                    <th>Titel</th>
                    <th><!-- descriptionicon --></th>
                    <th>Adress</th>
                    <th><!-- responsibleicon --></th>
                    <th>Tilldelad</th>
                    <th><!-- statuscmdlink --></th>
                    <th><!-- areatype --></th>
                    <th><!-- startdate --></th>
    ...
    <Row id="issue-tabproblem-page" hidden>
        ...
        <form id="issue-tabproblem-form">
            ...
            <Row>
                ...
                <Col md={6}>
                <div className="form-group">
                    <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="customername">Kund</label>
                    <Col md={9} className="input-group">
                    <span className="input-group-addon">
            ...
            <Row className="panel panel-default">
                ...
                <form id="create-issuefeedback-form">
                    ...
                    <Row>
                        <Col md={5}>
                        <div className="form-group">
                            <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="accesstype">Synlighet</label>
                            <Col md={9} className="input-group">
                            <span className="input-group-addon">
                                <span className="glyphicon glyphicon-ban-circle"></span>
                            </span>
                    ...
                    <Row>
                        <Col md={7}>
                        <div className="form-group">
                        <label className="control-label col-md-3" style="margin-left:-15px;margin-right:15px;" htmlFor="description">Kommentar</label>
                        <Col md={9} className="input-group">
                        <span className="input-group-addon">
                            <span className="glyphicon glyphicon-pencil"></span>
                        </span>
